...
elif [ "$VERSION" = "5.5.0"  ]; then
  UPDATE_URL="http://releases.s3.shopware.com.s3.amazonaws.com/update_5.5.0_b47dc4232520b56c8ec41b999d0ff9d43dbae6f3.zip"
elif [ "$VERSION" = "5.5.1"  ]; then
  UPDATE_URL="http://releases.s3.shopware.com.s3.amazonaws.com/update_5.5.1_d9e440b141186b6ee91b2f6e6a98a37455c5e2ce.zip"
elif [ "$VERSION" = "5.5.2"  ]; then
  UPDATE_URL="http://releases.s3.shopware.com.s3.amazonaws.com/update_5.5.2_a9571f222cb98b519e4bb025f50cfae2abea3461.zip"
elif [ "$VERSION" = "5.5.3"  ]; then
  UPDATE_URL="http://releases.s3.shopware.com.s3.amazonaws.com/update_5.5.3_3a4b8255d999cb3929fbf92f69f4448d36abb21f.zip"
elif [ "$VERSION" = "5.5.4"  ]; then
  UPDATE_URL="http://releases.s3.shopware.com.s3.amazonaws.com/update_5.5.4_319de4fc3888a5071314c6632121ca3406b8bf39.zip"
elif [ "$VERSION" = "5.5.5"  ]; then
  UPDATE_URL="http://releases.s3.shopware.com.s3.amazonaws.com/update_5.5.5_549a8ac1e91bac8eddde04d3bda42e922973aa46.zip"
elif [ "$VERSION" = "5.5.6"  ]; then
  UPDATE_URL="http://releases.s3.shopware.com.s3.amazonaws.com/update_5.5.6_95729ad73b619bd87149ef60f0d24a4d2beec5b0.zip"
elif [ "$VERSION" = "5.5.7"  ]; then
  UPDATE_URL="https://releases.shopware.com/update_5.5.7_5a8d8cb57f6d70de39231060532ac81e4831d40d.zip"
elif [ "$VERSION" = "5.5.8"  ]; then
  UPDATE_URL="https://releases.shopware.com/update_5.5.8_68ca21e9bda4f0db050b9ad01687d5432d2d9fa4.zip"
elif [ "$VERSION" = "5.5.9"  ]; then
  UPDATE_URL="https://releases.shopware.com/update_5.5.9_41fe713bfeafdcb7d44cb4a7cd5ca5ea393b67e0.zip"
elif [ "$VERSION" = "5.5.10"  ]; then
  UPDATE_URL="http://releases.shopware.com/update_5.5.10_1fefe5ce65759914f79a5f0c1b1a7ede9fab8043.zip"
elif [ "$VERSION" = "5.6.0"  ]; then
